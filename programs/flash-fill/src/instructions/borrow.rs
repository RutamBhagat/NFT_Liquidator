...
pub fn borrow_handler(ctx: Context<Borrow>) -> Result<()> {
    ...
    loop {
        ...
        if let Ok(ix) = load_instruction_at_checked(index, &ixs) {
            if ix.program_id == crate::id() {
                ...
                if ix_discriminator == crate::instruction::Repay::discriminator() {
                    require_keys_eq!(
                    ...
                    break;
                } else if ix_discriminator == crate::instruction::Borrow::discriminator() {
